...
class _AnalysisScreenState extends State<AnalysisScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Analysis', style: GoogleFonts.poppins(color: Color(0xFF00A8C5), fontWeight: FontWeight.bold)),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text('No Records Found', style: GoogleFonts.poppins(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.grey[600])),
          SizedBox(height: 10),
          Text('Add your first health record to begin analysis.', style: GoogleFonts.poppins(color: Colors.grey[500])),
          SizedBox(height: 30),
          ElevatedButton.icon(
            icon: Icon(Icons.add, color: Colors.white),
            label: Text('Add New Record', style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: Colors.white)),
            onPressed: () => _navigateAndAddRecord(context),
      ...
      itemBuilder: (context, index) {
        return Card(
          ...
          child: ListTile(
            ...
            title: Text('Anamnesis Record #${index + 1}', style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
